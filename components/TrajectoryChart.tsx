const POINTS =
  "0,33 10,30 20,31 30,26 40,27 50,22 60,24 70,18 80,20 90,13 100,10";
  ...
  return (
    <div className="chart">
      ...
      >
        ...
        <line x1="0" y1="8" x2="100" y2="8" className="chart-target" vectorEffect="non-scaling-stroke" />
        <path d={area} className="chart-area" />
        <path d={`M${POINTS}`} className="chart-line" pathLength={1} />
        <circle cx="100" cy="10" r="2.2" className="chart-dot" />
      </svg>
    </div>
  );
}
